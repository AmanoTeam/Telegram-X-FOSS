...
apply_patch \
    "${ROOT}/app/jni/tgvoip/third_party/rnnoise" \
    "${ROOT}/rnnoise-patches/0001-Namespace-vendored-celt-symbols-to-avoid-opus-clashes.patch"

echo "rnnoise patches applied successfully!"
